            ...
            <form ref={formRef} className='w-96 mx-auto mt-24 p-8 flex flex-col gap-4 shadow-lg backdrop-sepia-0 bg-white rounded-2xl'>
                ...
                <div className='w-full'>
                    <div className="input-bordered flex flex-col gap-2">
                        ...
                        <input ref={emailRef} defaultValue={'javazbek87@gmail.com'} type="email" className="grow border border-[#e5e7eb] px-4 w-[316px] h-12 rounded-lg bg-white" id='em' />
                    </div>
                    <div className="input-bordered flex flex-col gap-2">
                        <label className='text-[#394E6A] py-2 px-1 text-sm' htmlFor="pa">Password</label>
                        <input ref={passwordRef} defaultValue={'12345678'} type="password" className="grow border border-[#e5e7eb] px-4 w-[316px] h-12 rounded-lg bg-white" id='pa' />
                    </div>
